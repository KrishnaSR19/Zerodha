...
async function main() {
  try {
    ...
    // Clear the collection (optional, if you want fresh data every time)
    await HoldingsModel.deleteMany();
    console.log("Existing Holdings data cleared!");

    await PositionsModel.deleteMany();
    console.log("Existing Positions Data Cleared");
    ...
    console.log("Holdings Data Inserted!");
